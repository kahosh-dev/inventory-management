...
if(currentUser == null || editUser == null){
...
<title>Edit User - Inventory Management</title>
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .user-preview .preview-info { flex: 1; }
    .user-preview .preview-info .label {
        font-size: 12px;
        color: #94a3b8;
    ...
    .user-preview .preview-info .name {
        font-weight: 600;
        color: #0f172a;
        font-size: 16px;
    }
    ...
    @media (max-width: 768px) {
        ...
        .user-preview { flex-direction: column; text-align: center; }
    }
</style>
            ...
            <div class="card-body">
                ...
                <div class="user-preview">
                    ...
                    <div class="preview-info">
                        <div class="label">Editing User</div>
                        <div class="name"><%= editUser.getUsername() %></div>
                        <div class="text-muted small">ID: #<%= editUser.getId() %></div>
                    </div>
                </div>
                ...
                <form action="UpdateUserServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-custom">
                            ...
                            <input type="text" name="username" class="form-control" value="<%= editUser.getUsername() %>" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-custom">
                            ...
                            <input type="email" name="email" class="form-control" value="<%= editUser.getEmail() != null ? editUser.getEmail() : "" %>" placeholder="Enter email address">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-custom">
                                ...
                                <select name="role" class="form-control">
                                    <option value="User" <%= editUser.getRole().equals("User") ? "selected" : "" %>>User</option>
                                    <option value="Manager" <%= editUser.getRole().equals("Manager") ? "selected" : "" %>>Manager</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-custom">
                                ...
                                <select name="status" class="form-control">
                                    <option value="Active" <%= editUser.getStatus().equals("Active") ? "selected" : "" %>>Active</option>
                                    <option value="Inactive" <%= editUser.getStatus().equals("Inactive") ? "selected" : "" %>>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
